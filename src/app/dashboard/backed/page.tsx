  ...
  return (
    <div style={{ padding: "36px 32px 60px", maxWidth: 1100, margin: "0 auto" }}>
      ...
      <div style={{
        ...
        <div>
          <div style={{ marginBottom: 6 }}>
            <div style={{
              width: 120, height: 14, borderRadius: 8,
              background: isDark ? "rgba(255,255,255,0.06)" : "rgba(0,0,0,0.06)",
              animation: "pulse 2s ease-in-out infinite"
            }} />
          </div>
          <div style={{
            width: 280, height: 36, borderRadius: 12,
            background: isDark ? "rgba(255,255,255,0.08)" : "rgba(0,0,0,0.08)",
            animation: "pulse 2s ease-in-out infinite"
          }} />
        </div>
        <div style={{
          width: 280, height: 100, borderRadius: 14,
          background: isDark ? "rgba(255,255,255,0.06)" : "rgba(0,0,0,0.06)",
          animation: "pulse 2s ease-in-out infinite"
        }} />
      </div>
      ...
      <div style={{
        ...
        <div style={{
          width: 300, height: 14, borderRadius: 8, margin: "0 auto 28px",
          background: isDark ? "rgba(255,255,255,0.06)" : "rgba(0,0,0,0.06)",
          animation: "pulse 2s ease-in-out infinite"
        }} />
      </div>
...
function ErrorState({ error }: { error: string }) {
  return (
    ...
    >
      <div style={{
        padding: "24px", borderRadius: 16, background: "rgba(239,68,68,0.08)",
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          borderRadius: "50%", background: "rgba(255,136,0,0.06)",
      ...
      >
        ...
        <div style={{
          ...
          background: "linear-gradient(135deg,rgba(255,136,0,0.15),transparent)",
          pointerEvents: "none"
        }} />
      </motion.div>
      ...
      >
        {[
          ...
          ["💰", "Back", "Contribute any amount"],
          ["📈", "Track", "Watch your impact grow"]
  ...
  return (
    ...
    >
      ...
      <StatCard
        icon="💰"
        label="Total backed"
        value={`₹${totalBacked.toLocaleString("en-IN")}`}
        color="#34d399"
      />
    </motion.div>
  );
...
/* ════════════════════════════════════════════════════════════
   PAGE HEADER
════════════════════════════════════════════════════════════ */
function PageHeader({ hasBacked, totalBacked, projectsBacked }: {
  hasBacked: boolean; totalBacked: number; projectsBacked: number;
}) {
  return (
    <motion.div
      initial={{ opacity: 0, y: 12 }}
    ...
    >
        ...
        >
          <motion.div
            ...
            style={{
              ...
              background: "rgba(255,136,0,0.12)", border: "1px solid rgba(255,136,0,0.25)",
      ...
      {hasBacked && (
        <BackedStats totalBacked={totalBacked} projectsBacked={projectsBacked} />
      )}
    </motion.div>
  );
}
...
export default function BackedPage() {
  ...
  if (!mounted) return <BackedSkeleton />;

  // ✅ Loading state
  if (loading) return <BackedSkeleton />;
  ...
  return (
    ...
    >
      <PageHeader hasBacked={hasBacked} totalBacked={totalBacked} projectsBacked={projectsBacked} />
      ...
      {!hasBacked ? (
        ...
        >
          ...
          <p style={{
            fontFamily: "DM Sans, sans-serif", fontSize: 14,
            color: "var(--text-muted)", margin: "0 0 20px", maxWidth: 360, lineHeight: 1.6
          }}>
            Your backed projects will appear here. Start backing campaigns to see them listed.
          </p>
          <Link href="/explore" style={{
            display: "inline-flex", alignItems: "center", gap: 8, padding: "10px 20px",
            borderRadius: 12, background: "linear-gradient(135deg,#ff6b00,#ffcc00)",
            color: "#fff", textDecoration: "none", fontFamily: "Syne, sans-serif",
            fontWeight: 700, fontSize: 13, boxShadow: "0 0 24px rgba(255,100,0,0.4)",
            position: "relative", overflow: "hidden", cursor: "pointer"
          }}>
            <span style={{
              position: "absolute", inset: 0,
