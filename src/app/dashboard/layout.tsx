...
function UserDropdown({ user, initials, isCreator, isDark, handleLogout, onClose }: {
  user: UserResponse | null; initials: string; isCreator: boolean; isDark: boolean;
...
function MobileMenu({ navItems, pathname, isDark, user, initials, isCreator, handleLogout, onClose }: {
  navItems: NavItemConfig[]; pathname: string; isDark: boolean; user: UserResponse | null; initials: string;
