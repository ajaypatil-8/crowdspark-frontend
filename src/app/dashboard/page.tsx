...
════════════════════════════════════════════════════════════ */
function StatCard({
  label, value, raw, icon, color, delay
}: {
    ...
    >
      ...
      <div style={{
        ...
        <motion.div
          ...
          transition={{ delay: delay / 1000 + 0.3, type: "spring", stiffness: 100 }}
          style={{
            width: 44, height: 44, borderRadius: 14,
            background: `linear-gradient(135deg,${color}25,${color}10)`,
            border: `1px solid ${color}30`, display: "flex",
            alignItems: "center", justifyContent: "center", fontSize: 20,
            boxShadow: `0 0 16px ${color}20`,
          }}
        >{icon}</motion.div>
        <motion.div
          animate={vis ? { scale: [1, 1.2, 1] } : {}}
          transition={{ delay: delay / 1000 + 0.6, duration: 2, repeat: Infinity }}
          style={{
      ...
      <p style={{
        ...
        color: "var(--text)", margin: "0 0 4px", letterSpacing: "-0.03em", lineHeight: 1,
      }}>
        {vis ? <Counter to={raw} prefix={value.startsWith("₹") ? "₹" : ""} suffix={value.endsWith("L") ? "L" : ""} /> : "0"}
      </p>
      <p style={{
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ position: "relative", flexShrink: 0 }}>
          ...
          <div style={{
            ...
            <span style={{
              ...
              color: badge.color, transform: "rotate(90deg)"
            }}>{pct}</span>
          </div>
        </div>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
            <span style={{
              fontFamily: "Syne, sans-serif", fontWeight: 700, fontSize: 17, color: "var(--text)"
          ...
          <motion.span
            ...
            style={{
              ...
              borderRadius: 999, background: `${badge.color}15`, border: `1px solid ${badge.color}30`,
              fontSize: 12, fontWeight: 700, color: badge.color, fontFamily: "Syne, sans-serif",
            }}
          >{badge.emoji} {badge.label}</motion.span>
      ...
      <div style={{ padding: "16px 24px" }}>
        {todo.length > 0 && (
          <>
            <p style={{
              ...
              color: "var(--text-muted)", fontFamily: "DM Sans, sans-serif", marginBottom: 10
            }}>
                ...
                >
                  <Link href="/dashboard/profile" style={{
                    ...
                    onMouseEnter={e => {
                      ...
                      a.style.background = isDark ? "rgba(255,107,0,0.08)" : "rgba(255,107,0,0.05)";
                      a.style.borderColor = "rgba(255,107,0,0.3)";
                    }}
                    onMouseLeave={e => {
                      const a = e.currentTarget as HTMLAnchorElement;
                      a.style.background = isDark ? "rgba(255,255,255,0.025)" : "rgba(0,0,0,0.025)";
                      a.style.borderColor = isDark ? "rgba(255,255,255,0.05)" : "rgba(0,0,0,0.05)";
                    }}
                  >
                    <div style={{
                      width: 18, height: 18, borderRadius: 6,
                      border: "1.5px dashed rgba(255,107,0,0.4)", flexShrink: 0,
                      display: "flex", alignItems: "center", justifyContent: "center"
                    }}>
                      <div style={{
                        width: 4, height: 4, borderRadius: "50%", background: "rgba(255,107,0,0.4)"
                      }} />
                    </div>
                    <span style={{
                    ...
                    <span style={{
                      fontSize: 10, color: "#ff8800", fontWeight: 700,
        ...
        {done.length > 0 && todo.length > 0 && (
          <div style={{
            height: 1, background: isDark ? "rgba(255,255,255,0.05)" : "rgba(0,0,0,0.05)",
            margin: "12px 0"
          }} />
        )}
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
          {done.map((f, idx) => (
            <motion.span
              ...
              initial={{ opacity: 0, scale: 0.8 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ delay: 0.5 + todo.length * 0.05 + idx * 0.05 }}
              style={{
                display: "inline-flex", alignItems: "center", gap: 5, padding: "4px 9px",
                borderRadius: 999, background: "rgba(52,211,153,0.08)",
                border: "1px solid rgba(52,211,153,0.2)", fontSize: 11,
...
function ActivityFeed() {
  ...
  return (
    ...
    >
      <div style={{
        padding: "16px 20px", borderBottom: isDark ? "1px solid rgba(255,255,255,0.05)" : "1px solid rgba(0,0,0,0.04)",
        ...
        {items.map((item, i) => (
          <motion.div
            ...
            style={{
              ...
              borderRadius: 12, cursor: item.link ? "pointer" : "default",
              transition: "background 0.15s"
            }}
            onClick={() => item.link && (window.location.href = item.link)}
            onMouseEnter={e => {
              if (item.link) (e.currentTarget as HTMLDivElement).style.background = isDark ? "rgba(255,255,255,0.04)" : "rgba(0,0,0,0.03)";
            }}
            onMouseLeave={e => {
          ...
          >
            ...
            <span style={{
              fontSize: 11, color: item.color, fontFamily: "Syne, sans-serif",
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      {items.map((item, idx) => (
        <motion.div
          ...
          style={{
            padding: "12px 14px", borderRadius: 14, display: "flex",
        ...
        >
          ...
          <div>
            ...
            <p style={{
              fontFamily: "DM Sans, sans-serif", fontSize: 11, margin: 0,
              color: item.ok ? "#34d399" : item.warn ? "#f59e0b" : "#ef4444"
            }}>
...
function QuickActions() {
  ...
  const actions = [
    ...
    ...(isCreator
      ? [{ label: "Creator Dashboard", href: "/creator", icon: "🚀", color: "#ff6b00" }]
      : [{ label: "Become Creator", href: "/dashboard/become-creator", icon: "🚀", color: "#ff6b00" }]
    ),
  ];
        ...
        >
          <Link href={a.href} style={{
            ...
            onMouseLeave={e => {
              ...
              el.style.borderColor = isDark ? "rgba(255,255,255,0.06)" : "rgba(0,0,0,0.05)";
          ...
          >
            ...
            <span style={{
              position: "absolute", bottom: 10, right: 12, fontSize: 14,
  ...
  return (
    <div style={{ padding: "36px 32px 60px", maxWidth: 1100, margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: 36 }}>
        <div style={{
          width: 200, height: 14, borderRadius: 8,
          background: isDark ? "rgba(255,255,255,0.06)" : "rgba(0,0,0,0.06)",
          marginBottom: 12, animation: "pulse 2s ease-in-out infinite"
        }} />
        <div style={{
          width: 300, height: 40, borderRadius: 12,
      ...
      >
        ...
        >
          <Link href="/dashboard/profile" style={{
            ...
            fontWeight: 700, fontSize: 13, boxShadow: "0 0 24px rgba(255,100,0,0.35)",
